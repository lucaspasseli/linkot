...
var chalkDefault = chalk.blue;
var onError = function (error) {
    log(chalkError(error.code, 'Não foi possível encontrar o arquivo desejado.'));
};
var getFile = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, 3, 4]);
                return [4 /*yield*/, fs.promises.readFile(path, { encoding: encoding })];
            case 1:
                response = _a.sent();
